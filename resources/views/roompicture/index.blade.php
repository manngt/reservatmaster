...
@section('content')
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="form-group col s12">
                                    ...
                                    <form action="{{route('roompicture.destroy',$room_picture->id)}}" method="POST" style="display: inline">
                                        {{method_field('DELETE')}}
                                        @csrf
                                        <a class="btn-flat" href="{{ route('roompicture.edit',$room_picture->id) }}">
    ...
    <div class="fixed-action-btn" style="bottom: 50px; right: 19px;">
        ...
        <ul>
            <li>
                <a href="{{route('roompicture.create')}}" class="btn-floating blue">
