...
@section('content')
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="form-group col s12">
                                ...
                                <form action="{{route('roomtype.destroy',$room_type->id)}}" method="POST" style="display: inline">
                                    {{method_field('DELETE')}}
                                    @csrf
                                    <a class="btn-flat" href="{{ route('roomtype.edit',$room_type->id) }}">
    ...
    <div class="fixed-action-btn" style="bottom: 50px; right: 19px;">
        ...
        <ul>
            <li>
                <a href="{{route('roomtype.create')}}" class="btn-floating blue">
